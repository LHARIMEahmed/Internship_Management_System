...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Après avoir reçu les données utilisateur, rediriger en fonction du rôle
            // Pas besoin d'utiliser hasRole car nous avons directement les données de l'utilisateur
            if (userData && userData.role) {
                console.log("Utilisateur connecté avec rôle:", userData.role);
                ...
                switch (userData.role) {
                    case 'ROLE_ADMIN':
                        ...
                        break;
                    case 'ROLE_TUTEUR':
                        console.log("Redirection vers dashboard tuteur");
                        navigate('/tuteur-dashboard', { replace: true });
                        break;
                    case 'ROLE_STAGIAIRE':
                        console.log("Redirection vers dashboard stagiaire");
                        navigate('/stagiaire-dashboard', { replace: true });
                        break;
                    default:
                        console.log("Rôle non reconnu, redirection vers accueil");
                        navigate('/', { replace: true });
                }
            } else {
                // Si pour une raison quelconque les données utilisateur sont incomplètes
                console.log("Données utilisateur incomplètes, redirection vers accueil");
                navigate('/', { replace: true });
            }
    ...
    return (
        <div className="container mx-auto px-4 py-12 max-w-md">
            ...
            <div className="bg-white rounded-3xl shadow-xl overflow-hidden transform transition-all">
                ...
                {/* Visual header with decorative elements */}
